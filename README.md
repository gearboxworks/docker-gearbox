...
`./launch shell gearbox-base:ubuntu-xenial`

`./launch shell gearbox-base:ubuntu-xenial ls -l`

`./launch shell gearbox-base:ubuntu-xenial ps -eaf`
...
`./launch gearbox-base:ubuntu-xenial -flag1 -flag2 variable`
