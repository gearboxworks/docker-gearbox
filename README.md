...
Create, and start the gearbox-base Gearbox container with version ubuntu-bionic and run a shell.

`./launch shell gearbox-base:ubuntu-bionic`

`./launch shell gearbox-base:ubuntu-bionic ls -l`

`./launch shell gearbox-base:ubuntu-bionic ps -eaf`
...
`./launch gearbox-base:ubuntu-bionic -flag1 -flag2 variable`
