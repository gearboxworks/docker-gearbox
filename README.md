...
Create, and start the gearbox-base Gearbox container with version debian-wheezy and run a shell.

`./launch shell gearbox-base:debian-wheezy`

`./launch shell gearbox-base:debian-wheezy ls -l`

`./launch shell gearbox-base:debian-wheezy ps -eaf`
...
`./launch gearbox-base:debian-wheezy -flag1 -flag2 variable`
